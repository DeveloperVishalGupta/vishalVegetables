...
<body>
	<!-- body  -->
	<div class="container-fluid FruitsPageBanner" style="height: 60vh;">
		<div class="BannerOfferbg p-3">

		</div>
		<div class="position-relative" style="height: 55vh;">
			<div class="position-absolute FruitsbannerBGBlur"></div>
			<div class="FruitsBannerOffer d-flex flex-column justify-content-end pl-3 position-absolute px-4 py-4 text-light">
				<h4 class="text-uppercase">FRESH Fruit</h4>
	...
	<div class="mb-3 pb-2 pt-3 mt-3 px-5 row" style="background-color: #f7f7f7;">
		<div class="col-md-12 " style="line-height: 50px;">
			<h3 class="selectedCategry">Fresh Fruit</h3>
		</div>
	</div>
